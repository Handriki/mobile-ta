...
var ProfileService = /** @class */ (function () {
    function ProfileService(db) {
        this.profilesCollection = db.collection('profile');
        this.profiles = this.profilesCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
